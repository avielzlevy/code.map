...
import { FlowGraph, FrontendExecutionPath, ApiResponse } from '../dto/config.dto';
import { SidecarException } from '../exceptions/exceptions';
...
export class SidecarService {
  ...
  private serveStaticFrontend(): void {
    // At runtime __dirname = <repo>/backend/packages/nextjs/dist/sidecar/

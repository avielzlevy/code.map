import { Dot } from '../../../backend/packages/nestjs/src/decorators';
...
export class OrdersService {
  ...
  @Dot('Fetch and paginate user orders')
  ...
  @Dot('Create order and reserve inventory')
  ...
  @Dot('Cancel order and release inventory')
